...
const LineGraphRow = (props: LocaleModel) => {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 m-4 gap-4">
      <LineGraph data={enroll} label={props.t("trainer:enrollment_time")} />
      <LineGraph data={revenue} label={props.t("trainer:revenue_time")} />
      {/* <LineGraph /> */}
    </div>
  );
};

export default LineGraphRow;
